...
uint_8t DMA_Start(uint_32t MemoryAddress,uint_32t PeripheralAddress,uint_32t Counter,uint_8t ChannelNumber)
{
	uint_8t ErrorStatus=OK;
...
uint_8t DMA_SetNotifyCbf(Notify_t *Notification, uint_8t Channel_Number)
{
	uint_8t ErrorStatus=OK;
